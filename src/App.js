...
function App() {
  ...
  let viewItem = tableView ? <TableView books={booksToDisplay} updateBook={updateBook} readBook={readBook} deleteBook={deleteBook}> </TableView> :
    <CardsView books={booksToDisplay} updateBook={updateBook} readBook={readBook} deleteBook={deleteBook}> </CardsView>;
